"""
The following file is borrowed from https://github.com/aws/amazon-braket-examples
The file is distributed under Apache 2.0 license: http://www.apache.org/licenses/LICENSE-2.0
The code appears to have been written by Xiaosi Xu (https://www.linkedin.com/in/xiaosi-xu-381689104/,
https://github.com/xiaosi-xu) for educational purposes while working for and on AWS Braket.

This file appears to implement Quantum Fourier Transform which is used as part of Quantum Phase Estimation
"""
